...
import { refreshActionsTabData } from "../components/repository/actions/ActionsTab";
import { refreshAgentsTabData } from "../components/repository/agents/AgentsTab";
import { refreshCodeTabData } from "../components/repository/code/CodeTab";
import { refreshContributorsTabData } from "../components/repository/contributors/ContributorsTab";
import { refreshDiscussionsTabData } from "../components/repository/discussions/DiscussionsTab";
import { refreshIssuesTabData } from "../components/repository/issues/IssuesTab";
import { refreshProjectsTabData } from "../components/repository/projects/ProjectsTab";
import { refreshPullRequestsTabData } from "../components/repository/pull-requests/PullRequestsTab";
import { refreshReleasesTabData } from "../components/repository/releases/ReleasesTab";
